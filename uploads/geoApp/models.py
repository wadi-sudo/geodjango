...
'''class GeoappLocation(models.Model):
    name = models.CharField(max_length=100)
    location = models.PointField()

    class Meta:
        managed = False
        db_table = 'geoApp_location'''
...
class Road(models.Model):
    ...
    highway = models.CharField(max_length=10, blank=True, null=True)
...
class Cafe(models.Model):
    ...
    fclass = models.CharField(max_length=10, blank=True, null=True)
    name = models.CharField(max_length=10, blank=True, null=True)
    osm_id_2 = models.IntegerField(blank=True, null=True)
    name_2 = models.CharField(max_length=10, blank=True, null=True)
...
class Food(models.Model):
    ...
    path = models.CharField(max_length=10, blank=True, null=True)
